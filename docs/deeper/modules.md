...
The escape hatch, `AppFactory.getModule()`, instead retrieves the *exact same* instance of an
...
`this.container` (and `AppFactory.rootContainer`) is an instance of `Container` from this

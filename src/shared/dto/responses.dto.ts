...
export const createSuccessResponseDto = <T extends v.GenericSchema>(
	dataSchema: T,
) => {
	return v.object({
		data: dataSchema,
...
export type SuccessResponse<T extends v.GenericSchema> = v.InferOutput<
	ReturnType<typeof createSuccessResponseDto<T>>
>;
